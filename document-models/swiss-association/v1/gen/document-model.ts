      ...
      modules: [
        ...
        },
        {
          ...
          operations: [
            ...
            {
              id: "op-set-member-eth",
              name: "SET_MEMBER_ETHEREUM_ADDRESS",
              description:
                "Sets or updates a founding member's Ethereum wallet address",
              schema:
              ...
              errors: [
                {
                  id: "err-set-eth-not-found",
                  name: "MemberNotFoundForAddressError",
                  code: "MEMBER_NOT_FOUND_FOR_ADDRESS",
                  description:
                    "The member to set an Ethereum address for was not found",
                  template: "",
                },
                {
                  id: "err-set-eth-duplicate",
                  name: "DuplicateEthereumAddressError",
                  code: "DUPLICATE_ETHEREUM_ADDRESS",
                  description:
                    "The Ethereum address is already assigned to another member",
                  template: "",
                },
                {
                  id: "err-set-eth-already-signed",
                  name: "MemberAlreadySignedError",
                  code: "MEMBER_ALREADY_SIGNED",
                  description:
                    "The member has already signed for incorporation and cannot change address",
                  template: "",
                },
              ],
              examples: [],
        ...
        },
        {
          ...
          operations: [
            ...
            },
            {
              ...
              reducer:
                'const target = action.input.documentType === "AOA" ? (state.aoaDocument || (state.aoaDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false})) : action.input.documentType === "FOUNDING_MINUTES" ? (state.foundingMinutesDocument || (state.foundingMinutesDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false})) : action.input.documentType === "REG_GA" ? (state.regGaDocument || (state.regGaDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false})) : action.input.documentType === "DISSOLUTION_RESOLUTION" ? (state.dissolutionResolutionDocument || (state.dissolutionResolutionDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false})) : (state.mpaDocument || (state.mpaDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false}));\nif (target.isLocked) return;\ntarget.markdown = action.input.markdown;',
              errors: [],
              examples: [],
              scope: "global",
            },
        ...
        },
        {
          id: "mod-dissolution",
          name: "dissolution",
          description: "Operations for the dissolution and liquidation phase",
          operations: [
            {
              ...
              template: "Sets the dissolution/liquidation details",
              reducer:
        ...
        },
        {
          ...
          operations: [
            ...
            {
              id: "op-update-contrib",
              name: "UPDATE_CONTRIBUTOR_AGREEMENT",
              description: "Updates an existing contributor agreement",
              schema:
                "input UpdateContributorAgreementInput {\n  id: OID!\n  contractorIsEntity: Boolean\n  termType: ContributorTermType\n  contractorName: String\n  contractorNationality: String\n  contractorAddress: String\n  entityName: String\n  entityType: String\n  entityJurisdiction: String\n  role: String\n  contractDate: Date\n  workStartDate: Date\n  workEndDate: Date\n  terminationNoticePeriod: String\n  sowNumber: String\n  services: String\n  fteHours: String\n  compensation: String\n  denominationType: String\n  denominationCurrency: String\n}",
              template: "Updates an existing contributor agreement",
              reducer:
                "if (!state.contributorAgreements) state.contributorAgreements = [];\nconst agreement = state.contributorAgreements.find((a) => a.id === action.input.id);\nif (!agreement) throw new ContributorAgreementNotFoundError(`Contributor agreement ${action.input.id} not found`);\nif (action.input.contractorIsEntity !== undefined && action.input.contractorIsEntity !== null) agreement.contractorIsEntity = action.input.contractorIsEntity;\nif (action.input.termType) agreement.termType = action.input.termType;\nif (action.input.contractorName) agreement.contractorName = action.input.contractorName;\nif (action.input.contractorNationality) agreement.contractorNationality = action.input.contractorNationality;\nif (action.input.contractorAddress) agreement.contractorAddress = action.input.contractorAddress;\nif (action.input.entityName) agreement.entityName = action.input.entityName;\nif (action.input.entityType) agreement.entityType = action.input.entityType;\nif (action.input.entityJurisdiction) agreement.entityJurisdiction = action.input.entityJurisdiction;\nif (action.input.role) agreement.role = action.input.role;\nif (action.input.contractDate) agreement.contractDate = action.input.contractDate;\nif (action.input.workStartDate) agreement.workStartDate = action.input.workStartDate;\nif (action.input.workEndDate) agreement.workEndDate = action.input.workEndDate;\nif (action.input.terminationNoticePeriod) agreement.terminationNoticePeriod = action.input.terminationNoticePeriod;\nif (action.input.sowNumber) agreement.sowNumber = action.input.sowNumber;\nif (action.input.services) agreement.services = action.input.services;\nif (action.input.fteHours) agreement.fteHours = action.input.fteHours;\nif (action.input.compensation) agreement.compensation = action.input.compensation;\nif (action.input.denominationType) agreement.denominationType = action.input.denominationType;\nif (action.input.denominationCurrency) agreement.denominationCurrency = action.input.denominationCurrency;",
              errors: [
                {
                  id: "err-contrib-not-found-update",
                  name: "ContributorAgreementNotFoundError",
                  code: "CONTRIBUTOR_AGREEMENT_NOT_FOUND",
                  description:
                    "The specified contributor agreement was not found",
                  template: "",
                },
              ],
              examples: [],
            ...
            {
              id: "op-remove-contrib",
              name: "REMOVE_CONTRIBUTOR_AGREEMENT",
              description:
                "Removes a contributor agreement from the collection",
              schema: "input RemoveContributorAgreementInput {\n  id: OID!\n}",
              template: "Removes a contributor agreement from the collection",
              reducer:
                "if (!state.contributorAgreements) state.contributorAgreements = [];\nconst idx = state.contributorAgreements.findIndex((a) => a.id === action.input.id);\nif (idx === -1) throw new ContributorAgreementNotFoundError(`Contributor agreement ${action.input.id} not found`);\nstate.contributorAgreements.splice(idx, 1);",
              errors: [
                {
                  id: "err-contrib-not-found-remove",
                  name: "ContributorAgreementNotFoundError",
                  code: "CONTRIBUTOR_AGREEMENT_NOT_FOUND",
                  description:
                    "The specified contributor agreement was not found",
            ...
            {
              id: "op-set-contrib-md",
              name: "SET_CONTRIBUTOR_AGREEMENT_MARKDOWN",
              description:
                "Sets the generated markdown for a contributor agreement",
              schema:
                "input SetContributorAgreementMarkdownInput {\n  id: OID!\n  markdown: String!\n}",
              template:
                "Sets the generated markdown for a contributor agreement",
              reducer:
                "if (!state.contributorAgreements) state.contributorAgreements = [];\nconst agreement = state.contributorAgreements.find((a) => a.id === action.input.id);\nif (!agreement) throw new ContributorAgreementNotFoundError(`Contributor agreement ${action.input.id} not found`);\nif (!agreement.generatedDocument) agreement.generatedDocument = {markdown: null, isSigned: false, signedAt: null, isLocked: false};\nif (agreement.generatedDocument.isLocked) return;\nagreement.generatedDocument.markdown = action.input.markdown;",
              errors: [
                {
                  id: "err-contrib-not-found-setmd",
                  name: "ContributorAgreementNotFoundError",
                  code: "CONTRIBUTOR_AGREEMENT_NOT_FOUND",
                  description:
                    "The specified contributor agreement was not found",
            ...
            {
              id: "op-mark-contrib-signed",
              name: "MARK_CONTRIBUTOR_AGREEMENT_SIGNED",
              description:
                "Marks a contributor agreement as signed and locks it",
              schema:
                "input MarkContributorAgreementSignedInput {\n  id: OID!\n  signedAt: DateTime!\n}",
              template: "Marks a contributor agreement as signed and locks it",
              reducer:
              ...
              errors: [
                {
                  id: "err-contrib-not-found-marksigned",
                  name: "ContributorAgreementNotFoundError",
                  code: "CONTRIBUTOR_AGREEMENT_NOT_FOUND",
                  description:
                    "The specified contributor agreement was not found",
        ...
        {
          id: "mod-incorporation",
          name: "incorporation",
          description:
            "Operations for founding members to cryptographically sign for incorporation",
          operations: [
            {
              id: "op-sign-for-incorporation",
              name: "SIGN_FOR_INCORPORATION",
              description:
                "A founding member signs for incorporation using their wallet identity; the entity is incorporated once every founding member has signed",
              schema:
                "input SignForIncorporationInput {\n  signedAt: DateTime!\n}",
              template:
                "A founding member signs for incorporation; incorporation completes when all have signed",
              reducer:
              ...
              errors: [
                {
                  id: "err-sign-already-incorporated",
                  name: "AlreadyIncorporatedError",
                  code: "ALREADY_INCORPORATED",
                  description: "The entity is already incorporated",
                  template: "",
                },
                {
                  id: "err-sign-missing-signer",
                  name: "MissingSignerError",
                  code: "MISSING_SIGNER",
                  description: "The action carries no signer address",
                  template: "",
                },
                {
                  id: "err-sign-no-members",
                  name: "NoFoundingMembersError",
                  code: "NO_FOUNDING_MEMBERS",
                  description:
                    "There are no founding members to sign for incorporation",
                  template: "",
                },
                {
                  id: "err-sign-not-member",
                  name: "SignerNotFoundingMemberError",
                  code: "SIGNER_NOT_FOUNDING_MEMBER",
                  description:
                    "The signer address does not match any founding member's address",
                  template: "",
                },
                {
                  id: "err-sign-already-signed",
                  name: "AlreadySignedError",
                  code: "ALREADY_SIGNED",
                  description: "This founding member has already signed",
                  template: "",
                },
              ],
              examples: [],
